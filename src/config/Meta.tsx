...
export const siteConfig = {
  ...
  description: 'Web Developer & QA Enthusiast — Portofolio pribadi menampilkan project, pengalaman, dan keahlian teknis.',
  url: process.env.NEXT_PUBLIC_URL || 'http://localhost:3000',
  ogImage: '/meta/opengraph-image.png',
  author: {
    name: about.name,
    twitter: '',
    github: 'BenedictoGeraldo',
    linkedin: 'benedicto-geraldo',
